...
#Scenario: When the user clicks on the hamburger icon he can see the relevant options
Given the importers option is selected on the left menu
When the user clicks on the 3 dots icon
...
Given the user has clicked on the three dots icon under an importer
