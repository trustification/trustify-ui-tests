# This feature is described in this Jira.
#
# https://issues.redhat.com/browse/TC-2047

Feature: Denote CPE/pURL aliases of a component in an SPDX SBOM
...
Background:
    ...
    And User has successfully uploaded an SPDX SBOM that contains an alias (packages / externalRefs field) for a component.
