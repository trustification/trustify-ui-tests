...
#
# https://issues.redhat.com/browse/TC-2050

Feature: Denote the relationship between a source RPM and binary RPM in a CycloneDX SBOM
...
Background:
    ...
    And User has ingested an SBOM that contains the "ref" and "provides" relationship between dependency packages
